...
export function AboutHero() {
  const t = useTranslations("aboutRace.hero");
    ...
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        <motion.span
          ...
          className="inline-block px-4 py-1.5 bg-amber-500/10 border border-amber-500/20 text-amber-400 text-sm font-semibold tracking-wider uppercase rounded-full mb-6"
        >
          {t("badge")}
        </motion.span>
